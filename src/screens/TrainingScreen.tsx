...
const TrainingScreen = () => {
  ...
  const tips = [
    {
      ...
      content: "Separate wet (biodegradable), dry (recyclables), and hazardous waste at home. This makes processing faster and cheaper.",
      icon: "🗂️"
    },
    {
      id: 2,
      title: "Wet Waste → Compost",
      content: "Food scraps and garden waste can be composted locally, reducing landfill weight and producing useful compost.",
      icon: "🌱"
    },
    {
      id: 3,
      title: "Clean Recyclables",
      content: "Rinse plastic bottles and containers before tossing into recyclables — clean items fetch higher recycling value.",
      icon: "🧽"
    },
    {
      id: 4,
      title: "Handle Hazardous Waste Carefully",
      content: "Batteries, e-waste, chemicals must be kept separate and dropped at designated collection points.",
      icon: "⚠️"
    },
    {
      id: 5,
      title: "Reduce & Reuse",
      content: "Avoid single-use plastics, favor reusable items, and repair before discarding. Less waste = lower collection costs.",
      icon: "♻️"
    },
    {
      id: 6,
      title: "Report & Reward",
      content: "Use the app to report illegal dumping and earn points when you follow correct segregation habits.",
      icon: "📱"
    }
  ];
  ...
  const videos = [
    ...
    {
      id: "t3",
      title: "E-waste and Battery Disposal",
      ...
      <div className="min-h-screen p-6 pt-20">
          ...
          >
            <Card className="card-gradient border-success/50 bg-success/5">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">You've earned +10 bonus points!</p>
              </CardContent>
            </Card>
          </motion.div>
        )}
        ...
        >
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-semibold">{t('training.tips')}</h2>
        ...
        >
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-semibold">{t('training.videos')}</h2>
          </div>
        ...
        >
          <Card className="card-gradient text-center">
            ...
            <CardContent>
              ...
              >
                {quizCompleted ? 'Quiz Completed!' : 'Start Quiz (+10 points)'}
              </Button>
            </CardContent>
          </Card>
        </motion.section>
